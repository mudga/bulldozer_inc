...
function drawScene() { // main drawScene function
	...
	if(noT==0)
	{
			...
			canvas.width  =  wid;
			canvas.height =  hei;
			context.drawImage(win, 0, 0 , wid,hei);
                    context.strokeStyle = "#003300";
                    context.font = '40px san-serif';
                    context.textBaseline = 'bottom';
            context.fillText('your score: ' + iScore  + ' points', (wid/2)-20, hei-20);
		...
		{ // Finish after 30s
			...
			context.fillText('your score: ' + iScore + ' points', 50, 250);
